/* Javada koşullu ifadeler ile kullanıcı adı ve şifreyi kontrol eden programı yazınız. Eğer şifre yanlış ise kullanıcıya şifresini sıfırlayıp sıfırlamayacağını sorun,
...
şifreler aynı ise ekrana "Şifre oluşturulamadı, lütfen başka şifre giriniz." sorun yoksa "Şifre oluşturuldu" yazsın. */
